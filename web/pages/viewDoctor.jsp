...
<f:view>
    <html>
        <head>
            ...
            <title>Listing DoctorInfo Items</title>
        ...
        <h1>Listing DoctorInfo Items</h1>
        <h:form styleClass="jsfcrud_list_form">
            ...
            <h:panelGroup rendered="#{doctorInfo.pagingInfo.itemCount > 0}">
                <h:outputText value="Item #{doctorInfo.pagingInfo.firstItem + 1}..#{doctorInfo.pagingInfo.lastItem} of #{doctorInfo.pagingInfo.itemCount}"/>&nbsp;
                ...
                <h:dataTable value="#{doctorInfo.doctorInfoItems}" var="item" border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px">
                    <h:column>
                        <f:facet name="header">
                            <h:outputText value="Id"/>
                        </f:facet>
                        <h:outputText value="#{doctorInfo.category}"/>
                    </h:column>
                    <h:column>
                        <f:facet name="header">
                  ...
                  <%--  <h:column>
                    ...
                    <h:column>
                        ...
                        <h:commandLink value="Show" action="#{doctorInfo.detailSetup}">
                        ...
                        <h:outputText value=" "/>
                        <h:commandLink value="Edit" action="#{doctorInfo.editSetup}">
                            <f:param name="jsfcrud.currentDoctorInfo" value="#{jsfcrud_class['mpims.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][item][doctorInfo.converter].jsfcrud_invoke}"/>
                        </h:commandLink>
                        <h:outputText value=" "/>
                        <h:commandLink value="Destroy" action="#{doctorInfo.destroy}">
                            <f:param name="jsfcrud.currentDoctorInfo" value="#{jsfcrud_class['mpims.jsf.classes.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][item][doctorInfo.converter].jsfcrud_invoke}"/>
                        </h:commandLink>
                    </h:column>
                </h:dataTable>
            ...
            <br />
            <h:commandLink action="#{doctorInfo.createSetup}" value="New DoctorInfo"/>
