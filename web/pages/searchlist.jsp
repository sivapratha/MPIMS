    ...
    <html>
        ...
        <h:form styleClass="jsfcrud_list_form">
            ...
            <h:panelGroup rendered="#{doctorInfo.pagingInfo.itemCount > 0}">
              ...
              --%>  <br><br> <h:dataTable value="#{doctorInfo.searchDoctorInfo}" var="item" border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px">
               ...
               <%--     <h:column>
                  ...
                  <%--  <h:column>
                    ...
                    <h:column>
                        ...
                        <h:commandLink value="View" action="#{doctorInfo.searchDetails}">
